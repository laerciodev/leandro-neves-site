    ...
    return (
        <>
            ...
            <p className="text-contact">
                agora estamos prontos para te escutar nos conte 
                e daremos início ao seu projeto.
            </p>
            <form className="form-contato">
                <label className="label">nome</label>
                <input className="input" placeholder="digite seu nome" type="text" />
                <label className="label">e-mail</label>
                <input class="input" placeholder="seuemail@exemplo.com" type="email" />
                <label className="label">mensagem</label>
                <textarea placeholder="deixa a sua mensagem" className="input textarea"></textarea>
